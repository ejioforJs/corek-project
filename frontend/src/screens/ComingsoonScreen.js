  ...
  return (
    <div>
      ...
      <div className='px-16 mt-12 text-center'>
        ...
        <div className='mt-8 flex justify-center'><iframe src="https://giphy.com/embed/iTWomlMFQXIA5DN0VZ" width="480" height="321" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/ideekreativ-coming-soon-iTWomlMFQXIA5DN0VZ"></a></p></div>
      </div>
    </div>
  )
}
